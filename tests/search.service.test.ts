...
import { prisma } from '../src/server/models/database';

// Mock the prisma client
jest.mock('../src/server/models/database', () => ({
  prisma: {
    mCPServer: {
      findMany: jest.fn(),
      count: jest.fn()
...
// Mock the repository
jest.mock('../src/server/models/repositories', () => ({
  MCPServerRepository: {
    findAll: jest.fn(),
    count: jest.fn(),
...
import { MCPServerRepository } from '../src/server/models/repositories';
